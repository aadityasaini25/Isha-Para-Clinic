    ...
    <section className="py-16 md:py-24 px-4 md:px-8 bg-white overflow-hidden">
      <div className="max-w-5xl mx-auto">
        <div className="relative">
          <div className="absolute -top-12 -right-12 w-64 h-64 bg-[#C8226E]/8 rounded-full blur-3xl -z-10" />
          <div className="absolute -bottom-12 -left-12 w-64 h-64 bg-[#D4A95A]/10 rounded-full blur-3xl -z-10" />
          ...
          <motion.div
            ...
            className="bg-white rounded-[40px] shadow-[0_20px_50px_rgba(42,15,34,0.08)] border border-[#C8226E]/10 p-8 md:p-16 relative overflow-hidden group hover:shadow-[0_30px_60px_rgba(200,34,110,0.15)] transition-all duration-700"
          >
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              <div className="flex-1 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#FBEFF4] border border-[#C8226E]/20 mb-6">
                  <ShieldCheck className="w-3.5 h-3.5 text-[#C8226E]" strokeWidth={2.4} />
                  <span className="text-[#C8226E] text-xs font-bold tracking-widest uppercase">Insurance · TPA Coverage</span>
                </div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-1 gap-4 mb-10">
                  {benefits.map((benefit, i) => (
                    ...
                    >
                      <div className="mt-1 w-5 h-5 rounded-full bg-[#C8226E]/10 flex items-center justify-center shrink-0 group-hover/item:bg-[#C8226E] transition-colors duration-300">
                        <Check className="w-3 h-3 text-[#C8226E] group-hover/item:text-white transition-colors" strokeWidth={3} />
                      </div>
                ...
                <button
                  ...
                  className="bg-[#C8226E] text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-[#9E1A56] transition-all transform hover:scale-105 shadow-xl shadow-[#C8226E]/25 active:scale-95"
                >
              ...
              <div className="flex-1 relative w-full max-w-sm lg:max-w-none">
                <div className="relative rounded-[3rem] overflow-hidden aspect-[4/5] md:aspect-square shadow-[0_20px_60px_rgba(42,15,34,0.18)] group-hover:shadow-[0_30px_80px_rgba(200,34,110,0.25)] transition-all duration-700">
                  <div className="absolute top-6 right-6 z-20">
                    <div className="bg-gradient-to-r from-[#D4A95A] to-[#EBC97F] text-[#2A0F22] px-5 py-2.5 rounded-full text-sm font-black tracking-wider shadow-[0_8px_25px_rgba(212,169,90,0.45)] transform group-hover:scale-105 transition-transform">
                      ALL TPA · CASHLESS
                    </div>
                  </div>

                  {/* Brand-colored gradient panel (no need for stock photo) */}
                  <div className="absolute inset-0 bg-gradient-to-br from-[#C8226E] via-[#2A0F22] to-[#170818]">
                    <div className="absolute inset-0 bg-pattern-dots opacity-30" />
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-[#D4A95A] rounded-full blur-3xl opacity-30 animate-pulse" />
                  </div>
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-8 md:p-10">
                    ...
                    <div className="pt-6">
                      <div className="inline-flex items-center bg-white/95 backdrop-blur-md px-5 py-2 rounded-xl shadow-2xl">
                        <span className="text-[#2A0F22] font-bold text-sm tracking-tight">25+ Years Trusted Surgeon</span>
                      </div>
                    </div>
                  </div>
                </div>
