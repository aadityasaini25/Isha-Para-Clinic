...
export default function WhyChooseUs() {
  return (
    <section className="py-20 md:py-28 px-4 md:px-8 bg-[#fdf7fc]">
      <div className="max-w-6xl mx-auto">
        <div className="text-center md:text-left mb-12">
          <p className="text-[#964782] font-semibold text-sm uppercase tracking-[0.2em] mb-2">Why Beaudent Dental Care</p>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight mb-4">
            Why Choose Beaudent Dental Care
          </h2>
          <div className="w-16 h-0.5 bg-[#964782] rounded-full mx-auto md:mx-0" />
        </div>
