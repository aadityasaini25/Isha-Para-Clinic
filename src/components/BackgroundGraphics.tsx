...
export default function BackgroundGraphics() {
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden select-none">
      {/* Dynamic Blobs */}
      <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-[#964782] rounded-full blur-[80px] opacity-[0.08] animate-pulse" />
      <div className="absolute bottom-[-5%] right-[-5%] w-[400px] h-[400px] bg-[#5d2350] rounded-full blur-[70px] opacity-[0.05] soft-float" />
      ...
      <div className="absolute top-1/4 right-[10%] opacity-20 soft-float" style={{ animationDelay: '1s' }}>
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="text-[#964782]">
      ...
      <div className="absolute bottom-1/3 left-[5%] opacity-15 soft-float" style={{ animationDelay: '3s' }}>
        <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="text-[#5d2350]">
