...
export default function ThankYouPage() {
  return (
    <div className="min-h-screen bg-[#FAF6EE] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-100">
        <div className="bg-gradient-to-r from-[#C8226E] to-[#2A0F22] p-8 text-center">
        ...
        <div className="p-6 md:p-10">
          <div className="flex flex-col md:flex-row items-center gap-8 mb-10">
            <div className="w-44 h-44 relative rounded-full overflow-hidden border-4 border-[#FBEFF4] shadow-lg shrink-0 bg-gradient-to-br from-[#C8226E] to-[#2A0F22]">
              <Image
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-[#C8226E] font-semibold mb-4 text-sm uppercase tracking-widest">
          ...
          <div className="border-t border-slate-100 pt-8">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-10">
              {[
                ...
                <div key={step.n} className="bg-[#FAF6EE] p-5 rounded-2xl text-center border border-slate-100">
                  <div className="w-10 h-10 mx-auto mb-3 rounded-full bg-gradient-to-br from-[#C8226E] to-[#2A0F22] flex items-center justify-center text-white font-black text-sm">
                    {step.n}
                  </div>
          ...
          <div className="grid sm:grid-cols-2 gap-3 mb-8">
            <div className="bg-[#FAF6EE] rounded-xl p-4 flex items-start gap-3 border border-slate-100">
              <MapPin className="w-5 h-5 text-[#C8226E] mt-0.5 shrink-0" />
              <div>
            ...
            <div className="bg-[#FAF6EE] rounded-xl p-4 flex items-start gap-3 border border-slate-100">
              <Clock className="w-5 h-5 text-[#C8226E] mt-0.5 shrink-0" />
              <div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              className="inline-flex justify-center items-center px-7 py-3.5 bg-[#C8226E] text-white font-semibold rounded-full hover:bg-[#9E1A56] transition-all gap-2 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
            >
            ...
            <a
              href="/"
              className="inline-flex justify-center items-center px-7 py-3.5 bg-white text-[#2A0F22] font-semibold rounded-full border-2 border-slate-200 hover:border-[#C8226E] hover:text-[#C8226E] transition-colors"
            >
              Back to Home
            </a>
          </div>
